...
/// <summary>
/// Provides an implementation of the IJobPublisher interface that publishes jobs using the Absurd job system.
/// </summary>
/// <remarks>This class is intended for internal use within the job publishing infrastructure. It validates job
/// names and types against the provided AbsurdRegistry before dispatching jobs to the underlying IAbsurd
/// client.</remarks>
internal class AbsurdJobPublisher : IJobPublisher
{
    private readonly IAbsurd _client;
    private readonly AbsurdRegistry _registry;

    public AbsurdJobPublisher(IAbsurd client, AbsurdRegistry registry)
    {
        _client = client;
        _registry = registry;
    }
