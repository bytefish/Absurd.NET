...
public class AbsurdRegistry
{
    ...
    /// implementation of IAbsurd, an IServiceProvider for dependency resolution, and returning a Task representing the
    /// asynchronous operation.</remarks>
    public Dictionary<string, List<Func<IAbsurd, IServiceProvider, Task>>> JobRegistrationsByQueue { get; } = new();
