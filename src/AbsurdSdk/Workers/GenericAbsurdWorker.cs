...
/// <summary>
/// A Generic Worker that is responsible for polling a specific queue and executing tasks from that queue using the Absurd Client.
/// </summary>
internal class AbsurdGenericWorker : BackgroundService
{
    private readonly IAbsurd _client;
    private readonly IServiceProvider _provider;
    private readonly AbsurdRegistry _registry;
    private readonly ILogger<AbsurdGenericWorker> _logger;
    private readonly string _queueName;

    public AbsurdGenericWorker(
        IAbsurd client,
        IServiceProvider provider,
        AbsurdRegistry registry,
        ILogger<AbsurdGenericWorker> logger,
        string queueName)
    {
        _client = client;
        _provider = provider;
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        var innerWorker = new AbsurdWorker(workerOptions, _client);
